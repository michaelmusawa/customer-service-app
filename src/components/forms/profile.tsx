    ...
    <div className="gap-2 items-end">
      ...
      <div className="flex">
        <div className="w-1/3  h-2/3 mx-auto relative">
          <Image src={preview || '/images/avator.jpg'}
            width={150}
            height={100}
            alt="profile image"
            className="m-auto"
          />
        <label className="text-gray-700 text-sm ml-11 bottom-[5px] px-1 border rounded-lg pointer-events-none absolute">Choose Image</label>
        <input 
